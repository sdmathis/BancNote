...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x18a0ce;
...
const char     CRYPTONOTE_NAME[]                             = "bancnote";
...
const int      P2P_DEFAULT_PORT                              = 18125;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18126;
